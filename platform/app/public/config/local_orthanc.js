  ...
  dataSources: [
    {
      ...
      configuration: {
        ...
        name: 'isis',
        wadoUriRoot: 'http://localhost:8042/pacs/dicom-web',
        qidoRoot: 'http://localhost:8042/pacs/dicom-web',
        wadoRoot: 'http://localhost:8042/pacs/dicom-web',
